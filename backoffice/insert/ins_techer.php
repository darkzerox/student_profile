<?php
	...
	if (isset($_POST['per_name'])) {
		if ($_POST['per_password']==$_POST['per_password']) {
			...
			$sql = "INSERT INTO `personal`(`per_name`, `per_lastname`, `per_address`, `per_tel`, `per_email`, `per_username`, `per_password`,`pertype_id`) VALUES ('".$_POST['per_name']."','".$_POST['per_lastname']."','".$_POST['per_address']."','".$_POST['per_tel']."','".$_POST['per_email']."','".$_POST['per_username']."','".$_POST['per_password']."','1')";
	...
	<div class="wrap" style="position: relative;top: 120px;">
		<div class="wrap_inner">
			<div class="overflo ins">
				...
				<form method="post" action="ins_techer.php">
					<table>
						<tr>
							<td>ชื่อ : </td>
						...
						<tr>
							<td>อีเมล : </td>
							<td><input type="" name="per_email" required></td>
						</tr>
						<tr>
							<td>Username : </td>
