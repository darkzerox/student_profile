            ...
            <table class="table table-bordered">
                ...
                ?>
                    <tr>
                        ...
                        <td style="text-align:center;"><a href="dev.php?id=<?= $result['st_id'] ?>">เพิ่มพัฒนาการ</a></td>
                        <td style="text-align:center;"><a href="dev_student.php?id=<?= $result['st_id'] ?>">ดูพัฒนาการ</a></td>
                    </tr>
                <?php 
                }
                ?>
